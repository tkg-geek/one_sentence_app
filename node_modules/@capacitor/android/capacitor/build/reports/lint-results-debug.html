...
<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
  <header class="mdl-layout__header">
    <div class="mdl-layout__header-row">
      ...
      <nav class="mdl-navigation mdl-layout--large-screen-only">Check performed at Wed Feb 12 16:39:08 JST 2025 by AGP (8.8.0)</nav>
    </div>
  </header>
  <div class="mdl-layout__drawer">
    ...
    <nav class="mdl-navigation">
      ...
      <a class="mdl-navigation__link" href="#UnsanitizedFilenameFromContentProvider"><i class="material-icons error-icon">error</i>Trusting ContentProvider filenames without any sanitization (1)</a>
    </nav>
  </div>
...
<a href="#UnsanitizedFilenameFromContentProvider">UnsanitizedFilenameFromContentProvider</a>: Trusting ContentProvider filenames without any sanitization</td></tr>
...
<a name="Security"></a>
<a name="UnsanitizedFilenameFromContentProvider"></a>
<section class="section--center mdl-grid mdl-grid--no-spacing mdl-shadow--2dp" id="UnsanitizedFilenameFromContentProviderCard" style="display: block;">
            <div class="mdl-card mdl-cell mdl-cell--12-col">
  <div class="mdl-card__title">
    <h2 class="mdl-card__title-text">Trusting ContentProvider filenames without any sanitization</h2>
  </div>
              <div class="mdl-card__supporting-text">
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../src/main/java/com/getcapacitor/FileUtils.java">../../src/main/java/com/getcapacitor/FileUtils.java</a>:222</span>: <span class="message">Using <code>name</code> is unsafe as it is a filename obtained directly from a <code>ContentProvider</code>. You should sanitize it before using it for creating a <code>File</code>.</span><br /><pre class="errorlines">
<span class="lineno"> 219 </span>        <span class="keyword">int</span> nameIndex = cursor.getColumnIndex(OpenableColumns.DISPLAY_NAME);
<span class="lineno"> 220 </span>        cursor.moveToFirst();
<span class="lineno"> 221 </span>        String name = (cursor.getString(nameIndex));
<span class="caretline"><span class="lineno"> 222 </span>        File file = <span class="keyword">new</span> File(context.getFilesDir(), <span class="error">name</span>);&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 223 </span>        <span class="keyword">try</span> {
<span class="lineno"> 224 </span>            InputStream inputStream = context.getContentResolver().openInputStream(uri);
<span class="lineno"> 225 </span>            FileOutputStream outputStream = <span class="keyword">new</span> FileOutputStream(file);
</pre>

</div>
<div class="metadata"><div class="explanation" id="explanationUnsanitizedFilenameFromContentProvider" style="display: none;">
  When communicating between applications with files, the server app can provide the client app with a maliciously constructed filename. The client app should never trust this filename and should either sanitize it or completely discard it.<br/><div class="moreinfo">More info: <a href="https://developer.android.com/privacy-and-security/risks/untrustworthy-contentprovider-provided-filename">https://developer.android.com/privacy-and-security/risks/untrustworthy-contentprovider-provided-filename</a>
</div>To suppress this error, use the issue id "UnsanitizedFilenameFromContentProvider" as explained in the <a href="#SuppressInfo">Suppressing Warnings and Errors</a> section.<br/>
<br/></div>
</div>
</div>
<div class="chips">
<span class="mdl-chip">
    <span class="mdl-chip__text">UnsanitizedFilenameFromContentProvider</span>
</span>
<span class="mdl-chip">
...
<span class="mdl-chip">
    <span class="mdl-chip__text">Priority 6/10</span>
              ...
              <div class="mdl-card__actions mdl-card--border">
<button class="mdl-button mdl-js-button mdl-js-ripple-effect" id="explanationUnsanitizedFilenameFromContentProviderLink" onclick="reveal('explanationUnsanitizedFilenameFromContentProvider');">
Explain</button><button class="mdl-button mdl-js-button mdl-js-ripple-effect" id="UnsanitizedFilenameFromContentProviderCardLink" onclick="hideid('UnsanitizedFilenameFromContentProviderCard');">
Dismiss</button>            </div>
            </div>
          </section>
